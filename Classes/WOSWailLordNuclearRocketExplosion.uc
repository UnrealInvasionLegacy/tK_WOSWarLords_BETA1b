class WOSWailLordNuclearRocketExplosion extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         VelocityScale(2)=(RelativeTime=0.700000,RelativeVelocity=(X=1200.000000,Y=1200.000000,Z=400.000000))
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(0)=SpriteEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         SphereRadiusRange=(Min=13.000000,Max=26.000000)
         MeshSpawningStaticMesh=StaticMesh'ParticleMeshes.Simple.ParticleSphere3'
         MeshScaleRange=(Z=(Min=2.000000,Max=2.000000))
         RevolutionsPerSecondRange=(Z=(Min=-0.200000,Max=0.200000))
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(1)=SpriteEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         MaxParticles=150
         StartLocationShape=PTLS_Sphere
         SphereRadiusRange=(Min=26.000000,Max=26.000000)
         MeshSpawningStaticMesh=StaticMesh'ParticleMeshes.Simple.ParticleSphere3'
         ...
         VelocityScale(1)=(RelativeTime=0.500000)
         VelocityScale(2)=(RelativeTime=0.700000,RelativeVelocity=(X=1200.000000,Y=1200.000000,Z=400.000000))
         VelocityScale(3)=(RelativeTime=1.000000,RelativeVelocity=(X=120.000000,Y=120.000000,Z=40.000000))
     End Object
     Emitters(2)=SpriteEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         MaxParticles=50
         StartLocationShape=PTLS_Sphere
         SphereRadiusRange=(Min=26.000000,Max=52.000000)
         MeshSpawningStaticMesh=StaticMesh'ParticleMeshes.Simple.ParticleSphere3'
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
         VelocityScale(1)=(RelativeTime=0.500000)
         VelocityScale(2)=(RelativeTime=0.700000,RelativeVelocity=(X=800.000000,Y=800.000000,Z=200.000000))
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(3)=SpriteEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.SpriteEmitter3'
     ...
     End Object
     Emitters(4)=MeshEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.MeshEmitter0'
     ...
     End Object
     Emitters(5)=MeshEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.MeshEmitter1'
     ...
     End Object
     Emitters(6)=SpriteEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         MaxParticles=2
         SizeScale(0)=(RelativeSize=1.000000)
         SizeScale(1)=(RelativeTime=0.700000,RelativeSize=7.000000)
         SizeScale(2)=(RelativeTime=1.000000,RelativeSize=0.750000)
         InitialParticlesPerSecond=50000.000000
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(7)=SpriteEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         StartLocationShape=PTLS_Sphere
         SphereRadiusRange=(Min=102.000000,Max=102.000000)
         StartSpinRange=(X=(Min=0.500000,Max=0.500000))
         StartSizeRange=(X=(Min=30.000000,Max=30.000000),Y=(Min=15.000000,Max=15.000000))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(8)=SpriteEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.SpriteEmitter6'
     ...
     End Object
     Emitters(9)=MeshEmitter'tK_WOSWarLords_BETA1b.WOSWailLordNuclearRocketExplosion.MeshEmitter2'
